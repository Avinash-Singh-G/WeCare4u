...
Streamlit is used to deply the Machine Learning part of our project. It has also been used to create the input form and calendar (ics file) implementation of the project.
